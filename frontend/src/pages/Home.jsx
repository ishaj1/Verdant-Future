...
export default function HomePage() {
  ...
  return (
    <>
      <Header />
      {/* <div className="w-full bg-customGreen-50 relative h-full"> */}
      <div className="relative h-screen bg-customGreen-50">
        <div className="grid h-full max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28"> 
          <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Get your company evaluated or get funds for your green project by <Link to="/registeration" class="hover:underline">signing up</Link>.</p>
          </div>
